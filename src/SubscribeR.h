...
std::vector<signed long long>* 	rros_stream_read_int64_array	(IStreamR *s, unsigned int size=0);
std::vector<unsigned long long>*	rros_stream_read_uint64_array	(IStreamR *s, unsigned int size=0);
